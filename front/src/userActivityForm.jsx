...
//         try {
//             // Ajustar datos según el tipo antes de enviar
//             const dataToSave = { ...formData };

//             // Para multiplechoice, ajustar el answer (sumar 1)
...
// const MultiplechoiceFormContent = ({ formData, setFormData, item }) => {
...
// // ===== ATLAS FORM CONTENT =====
// const AtlasFormContent = ({ formData, setFormData }) => {
//     const handleChange = (e) => {
//         setFormData({ ...formData, [e.target.name]: e.target.value });
//     };
...
//                                         ⚠️ Las opciones no pueden repetirse
//                                     </div>
//                                 )}
//                                 {q.options.map((option, optIndex) => (
//                                     <div key={optIndex} className="option-row">
                    ...
                    return (
                        <div key={pageIndex} className="page-card">
                            ...
                            <div className="items-section">
                                ...
                                {hasDuplicates && (
                                    <div className="error-message-inline">
                                        ⚠️ Los items no pueden repetirse
                                    </div>
                                )}
