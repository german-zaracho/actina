...
//     return call({ url: "admin/users", method: "GET" });
// }

// export function getUserById(id) {
//     return call({ url: `admin/users/${id}`, method: "GET" });
// }

// export function createUser(data) {
//     return call({ url: "admin/users", method: "POST", body: data });
// }

// export function updateUser(id, data) {
//     return call({ url: `admin/users/${id}`, method: "PUT", body: data });
// }

// export function deleteUser(id) {
//     return call({ url: `admin/users/${id}`, method: "DELETE" });
// }
...
export function getDashboardStats() {
    return call({ url: "admin/stats", method: "GET" });
}