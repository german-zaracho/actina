                ...
                <table className="admin-table">
                    <thead>
                        <tr>
                            <th>Materia</th>
                            <th>Clasificación</th>
                            <th>Preguntas y Justificación</th>
                            <th>Acciones</th>
                        </tr>
                    </thead>
                    <tbody>
                        {groups.map(group => {
                            ...
                            const justifiedQuestions = group.questions?.filter(
                                q => q.justification && q.justification.trim() !== ''
                            ).length || 0;
                            
                            return (
                                <tr key={group._id}>
                                    <td data-label="Materia">{group.subject}</td>
                                    <td data-label="Clasificación">{group.classification}</td>
                                    <td data-label="Preguntas/Justificación">
                                        {totalQuestions} preguntas / {justifiedQuestions} justificaciones
                                    </td>
