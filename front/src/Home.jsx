...
//         if (!text || matchedTerms.length === 0) return text;

//         // 1️⃣ Filtrar términos cortos (mínimo 2 caracteres según requerimiento)
...
//         // 2️⃣ Escapar caracteres especiales de regex
//         const escapedTerms = terms.map(t =>
//             t.replace(/[.*+?^${}()|[\]\\]/g, '\\$&')
//         );

//         // 3️⃣ Crear regex única con todos los términos
//         const regex = new RegExp(`(${escapedTerms.join('|')})`, 'gi');

//         // 4️⃣ Split + map (evita replace encadenado que puede causar problemas)
...
//                 partNormalized === normalizeText(term.toLowerCase())
//             );
...
//                                                 >
//                                                     <h5>
//                                                         {renderHighlightedText(item.subject, item.matchedTerms)}
//                                                     </h5>
//                                                     <p>
//                                                         {renderHighlightedText(item.classification, item.matchedTerms)}
//                                                     </p>
...
//                                                                         {term}{idx < item.matchedTerms.length - 1 ? ', ' : ''}
//                                                                     </span>
//                                                                 ))}
//                                                             </span>
//                                                         )}
...
//                                                     </h5>
//                                                     <p>
//                                                         {renderHighlightedText(item.topic, item.matchedTerms)}
//                                                     </p>
//                                                     <span className="resultMeta">
...
//                                                     </h5>
//                                                     <p>
//                                                         {renderHighlightedText(item.type, item.matchedTerms)}
//                                                     </p>
//                                                     <span className="resultMeta">
