...
route.get('/admin/users/:id', [validateToken, validateAdmin], adminControllers.getUserById);
route.post('/admin/users', [validateToken, validateAdmin], adminControllers.createUser);
route.put('/admin/users/:id', [validateToken, validateAdmin], adminControllers.updateUser);
route.delete('/admin/users/:id', [validateToken, validateAdmin], adminControllers.deleteUser);

// Dashboard Stats
route.get('/admin/stats', [validateToken, validateAdmin], adminControllers.getDashboardStats);
